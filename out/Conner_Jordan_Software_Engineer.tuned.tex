...
I am a passionate and driven software engineer with a proven track record of developing innovative and robust solutions. My experience spans across the full software development lifecycle, from conception to deployment, with a strong focus on writing clean, efficient, and maintainable code in Python. I am familiar with security frameworks and best practices.
...
\textbf{Cloud and DevOps:} AWS, Google Cloud Platform, Azure, Docker, Kubernetes, Lambda, Ansible, Terraform, CI/CD (GitHub Actions, Jenkins)
% === LLM:CHUNK END SKILLS.Cloud & DevOps ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.AI & LLM Tools ===
\textbf{AI and LLM Tools:} Claude Code, LangChain, LM Studio, Ollama, MLX, Vector Databases (Chroma, Pinecone)
% === LLM:CHUNK END SKILLS.AI & LLM Tools ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Automation & Productivity ===
\textbf{Automation and Productivity:} Git, Postman, Selenium, GitHub Copilot, Raycast, PowerToys, Crontab, Shell Scripting
% === LLM:CHUNK END SKILLS.Automation & Productivity ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Security & Operating Systems ===
\textbf{Security \& Operating Systems:} Rapid7, CrowdStrike, Jamf, BigFix, ServiceNow, Vulnerability Management, OWASP Top 10, Web Security Testing (Burp Suite, OWASP Juice Shop), API Security, Incident Response, Data Loss Prevention
