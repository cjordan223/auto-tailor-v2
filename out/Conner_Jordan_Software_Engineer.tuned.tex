...
Passionate and driven software engineer with a proven track record of developing innovative and robust AI-powered applications.  Experience spans the full software development lifecycle, from conception to deployment, with a strong focus on clean, efficient, and maintainable code in Python. Proven ability to build and deploy ML/DL models in production, integrating intelligent systems across the entire member journey, and delivering real-world impact through scalable, thoughtful innovation.
...
\textbf{Programming Languages:} Python, TypeScript, Java, C/C++, SQL, Swift, PowerShell, Bash, Node.js
...
\textbf{Cloud \& DevOps:} AWS, Google Cloud Platform, Azure, Docker, Kubernetes, Lambda, Ansible, Terraform, CI/CD (GitHub Actions, Jenkins), MLflow, Airflow, SageMaker Pipelines
% === LLM:CHUNK END SKILLS.Cloud & DevOps ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.AI & LLM Tools ===
\textbf{AI \& LLM Tools:} Claude Code, LangChain, LM Studio, Ollama, MLX, Vector Databases (Chroma, Pinecone), PyTorch, TensorFlow, Hugging Face
