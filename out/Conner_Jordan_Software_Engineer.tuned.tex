...
I am a passionate and driven software engineer with a proven track record of developing innovative and robust solutions, particularly with Node.js and TypeScript. My experience spans across the full software development lifecycle, with a strong focus on writing clean, efficient, and maintainable code.
...
\textbf{Backend:} Node.js, Express.js, Django, Flask, Spring Boot, FastAPI, .NET, RESTful \& GraphQL API Development, Apollo Server
