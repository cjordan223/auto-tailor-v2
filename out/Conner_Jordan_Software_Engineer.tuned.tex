...
Passionate and driven software engineer with 3+ years of experience building and deploying machine learning models at scale. Proven ability to bridge the gap between data science and software engineering, taking models from prototype to production. Expertise in Python, TensorFlow/PyTorch, and cloud platforms (AWS, GCP, Azure).  Proficient in MLOps principles and tools, including CI/CD, model monitoring, and versioning.  Seeking to leverage my skills to build innovative and robust solutions for AdOptics Marketing.
...
\textbf{Programming Languages:} Python, Java, C/C++, C++, TensorFlow, PyTorch, Scikit-learn
...
\textbf{Cloud \& DevOps:} AWS, Google Cloud Platform, Azure, Docker, Kubernetes, Lambda, Ansible, Terraform, CI/CD (GitHub Actions, Jenkins), Airflow, Spark
% === LLM:CHUNK END SKILLS.Cloud & DevOps ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.AI & LLM Tools ===
\textbf{AI \& LLM Tools:} Claude Code, LangChain, LM Studio, Ollama, MLX, Vector Databases (Chroma, Pinecone), MLflow, Kubeflow, Seldon Core
% === LLM:CHUNK END SKILLS.AI & LLM Tools ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Automation & Productivity ===
\textbf{Automation \& Productivity:} Git, Postman, Selenium, GitHub Copilot, Raycast, PowerToys, Crontab, Shell Scripting, Pandas
...
\textbf{Databases:} MySQL, PostgreSQL, MongoDB, DynamoDB, Snowflake, Databricks, BigQuery
