...
I am a passionate Software Engineer with over three years of hands-on experience in developing robust backend systems using Python, Flask, and PostgreSQL. My expertise includes designing scalable solutions for high-concurrency applications, optimizing data storage and transit, and implementing CI/CD pipelines. I have successfully reduced system latency by 40\% through database optimization and maintained a 99.9\% uptime across production environments while mentoring junior developers.
...
\textbf{Backend:} Flask, Django, FastAPI, Spring Boot
% === LLM:CHUNK END SKILLS.Backend ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Cloud & DevOps ===
\textbf{Cloud \& DevOps:} AWS, Google Cloud Platform, Azure, Docker, Kubernetes, Terraform, CI/CD (GitHub Actions)
% === LLM:CHUNK END SKILLS.Cloud & DevOps ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.AI & LLM Tools ===
\textbf{AI \& LLM Tools:} Claude Code, LangChain, MLX
% === LLM:CHUNK END SKILLS.AI & LLM Tools ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Automation & Productivity ===
\textbf{Automation \& Productivity:} Git, Postman, Selenium, GitHub Copilot, Shell Scripting
% === LLM:CHUNK END SKILLS.Automation & Productivity ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Security & Operating Systems ===
\textbf{Security \& Operating Systems:} Rapid7, CrowdStrike, Jamf, BigFix, ServiceNow, OWASP Top 10, API Security
