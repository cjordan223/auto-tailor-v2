...
I am a dedicated security engineer with over two years of experience in developing robust security practices and implementing policies to protect digital assets. My expertise includes conducting regular security assessments, managing risk assessments for third-party vendors, and educating staff on information security through training programs.
...
\textbf{Security \& Operating Systems:} Rapid7, CrowdStrike, Jamf, BigFix, ServiceNow, Vulnerability Management, OWASP Top 10, Web Security Testing (Burp Suite, OWASP Juice Shop), API Security, Incident Response, Vanta, SecureFrame, Asana
