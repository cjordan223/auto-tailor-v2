...
I am a passionate Software Engineer with over two years of experience in developing robust back-end solutions using Python and PostgreSQL. My expertise includes designing scalable systems with Flask, Redis, and Celery, ensuring high performance and reliability for enterprise applications.
...
\textbf{Programming Languages:} Python, TypeScript, Java, C/C++, SQL
% === LLM:CHUNK END SKILLS.Programming Languages ===

\vspace{3pt}

% === LLM:CHUNK START SKILLS.Frontend ===
\textbf{Frontend:} React.js, Vue.js, Angular, Tailwind CSS, MUI, Vite, Next.js
...
\textbf{AI \& LLM Tools:} Claude Code, LangChain, LM Studio, Ollama, MLX
